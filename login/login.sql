...
CREATE TABLE `brukere` (
  `idbrukere` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `brukere` VALUES (1,'oleols','oleols'),(2,'perper','perper'),(3,'nilnil','nilnil'),(4,'piasav','piasav');
...
-- Dump completed on 2019-04-01  9:39:27
